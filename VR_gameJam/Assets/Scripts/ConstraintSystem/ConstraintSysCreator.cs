...
public abstract class ConstraintSysCreator : MonoBehaviour
{
    ...
    protected abstract bool AttachFirst();
    protected abstract bool AttachSecond();
    ...
    void Update()
    {
        ...
        switch (_State.Phase)
        {
            ...
            case Phases.AttachingConstrFirst:
                if (AttachFirst() && Menu.MenuIsShowing() == false)
                {
            ...
            case Phases.AttachingConstrSecond:
                ...
                if (AttachSecond() && Menu.MenuIsShowing() == false)
                {
